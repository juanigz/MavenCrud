...
public class VentanaForm extends JFrame 
{
    ...
    private void inicializar() 
    {
        ...
        _labelId.setFont(new java.awt.Font("Tahoma", 0, 14));
        _labelId.setText("ID:");

        _labelNombre.setFont(new java.awt.Font("Tahoma", 0, 14));
        _labelNombre.setText("NOMBRE:");

        _labelCircos.setFont(new java.awt.Font("Tahoma", 0, 14));
    ...
    private void Eliminar() 
    {
        ...
        try {
            if (fila >= 0) //esto de aca funciona, pero elimina la muestra de la tabla. cuando no deberia.
            {
