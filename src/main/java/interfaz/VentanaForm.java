...
import controlador.VentanaFormControlador;
...
public class VentanaForm extends JFrame {
    ...
    private void inicializar() {
        ...
        _labelId.setFont(new Font("Tahoma", 0, 14));
        _labelId.setText("ID:");

        _labelNombre.setFont(new Font("Tahoma", 0, 14));
        _labelNombre.setText("NOMBRE:");

        _labelCircos.setFont(new Font("Tahoma", 0, 14));
                ...
                jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING, false)
                                        .addComponent(_labelCircos, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
                                        .addComponent(_labelNombre, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
                                        .addComponent(_labelId, GroupLayout.Alignment.TRAILING,
                                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addGroup(
                                                jPanel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                                        .addComponent(_txtId, GroupLayout.Alignment.LEADING,
                                                                GroupLayout.DEFAULT_SIZE, 127, Short.MAX_VALUE)
                                                        .addComponent(_txtNombre))
                                        .addComponent(_txtCircos, GroupLayout.PREFERRED_SIZE, 127,
                ...
                jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(_txtNombre, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                        .addComponent(_txtCircos, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                GroupLayout.PREFERRED_SIZE)
        ...
        _tituloPrincipal.setFont(new Font("Tahoma", 1, 18));
        ...
        jPanel3Layout.setHorizontalGroup(
                jPanel3Layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel3Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(_botonAgregar, GroupLayout.PREFERRED_SIZE, 109,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(_botonModificar, GroupLayout.PREFERRED_SIZE, 113,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(_botonEliminar)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)
                                .addComponent(_botonLimpiar, GroupLayout.PREFERRED_SIZE, 104,
                                        GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
                        ...
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                                ...
                                                .addComponent(_tituloPrincipal, GroupLayout.PREFERRED_SIZE, 196,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addGap(147, 147, 147))
                                        .addGroup(layout.createSequentialGroup()
                                                .addGroup(layout
                                                        ...
                                                        .addComponent(jPanel1, GroupLayout.Alignment.LEADING,
                                                                ...
                                                                Short.MAX_VALUE)
                                                        .addComponent(_panelBD, GroupLayout.Alignment.LEADING,
                                                                GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE,
                                                                Short.MAX_VALUE)
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(jPanel3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(_panelBD, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                        GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
        pack();
    }
    ...
    private void TablaDatosMouseClicked(MouseEvent evt) {
    ...
    private void Agregar() {
        ...
        try {
            ...
            if (nombre.length() > 25 || circos.length() > 5) 
            {
                JOptionPane.showMessageDialog(null, "Datos Mal Ingresados.");
                limpiarTabla(model);
            } 
            else {
                Payaso payaso = VentanaFormControlador.generarPayaso(nombre, circos);
    ...
    private void Modificar()
    {
        ...
        try
        {
            if (nombre.isBlank() || circos.isBlank() || fila < 0 || nombre.length() > 25 || circos.length() > 5)
            {
